...
namespace MVCData.Helpers.SqlProgrammability.CommonTasks
{
    public class Commons
    {
        ...
        private void SplitToIntList()
        {
            ...
            this.totalBikePortalsEntities.CreateUserDefinedFunction("SplitToIntList", queryString);
        }
        ...
        private void EntireTerritories()
        {
            ...
            this.totalBikePortalsEntities.CreateView("VWEntireTerritories", queryString);
        }
